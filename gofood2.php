...
echo color("green","| github: Agus Syahputra S P |\n");
echo color("blue","| fanspage :ganteng dan manis|\n");
echo color("yellow","| Creator : matahantu.com          |\n");
echo "| Kata sambutan : semoga vouchernya keluar dan Agus Syahputra diterima kerja di tempat yang lebih baik      |\n";
...
// function change(){
        ...
        echo color("red","\n===========(REDEEM VOUCHER)===========");
        echo "\n".color("blue","!] Claim voc GOFOOD021120A");
        ...
        sleep(3);
        $goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD021120A"}');
